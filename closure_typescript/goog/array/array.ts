...
namespace goog {
  export var NATIVE_ARRAY_PROTOTYPES;
}
...
namespace goog.array {
  ...
  export var ASSUME_NATIVE_FUNCTIONS;
   ...
   * @template T
   */
  export function peek<T>(array: IArrayLike<T>|string): T {
   ...
   * @template T
   */
  export function last<T>(array: IArrayLike<T>|string): T {
  ...
  export function indexOf<T>(
      arr: IArrayLike<T>|string, obj: T,
      opt_fromIndex?: number|undefined): number {
    ...
    if (bo) {
      ...
      if (goog.isString(arr)) {
        ...
        if (!goog.isString(obj) || (<IArrayLike<any>>obj).length != 1) {
          return -1;
        } else if(typeof obj == 'string'){
            return (<string>arr).indexOf((<string>obj), fromIndex);
        }
      }

      for (var i = fromIndex; i < arr.length; i++) {
        if (i in <IArrayLike<any>>arr && arr[i] === obj) return i;
      }
      return -1;
    }
  }
  ...
  export function lastIndexOf<T>(
      arr: IArrayLike<T>|string, obj: T,
      opt_fromIndex?: (number|undefined)|null): number {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
      ...
      if (goog.isString(arr)) {
        ...
        if (!goog.isString(obj) || (<IArrayLike<any>>obj).length != 1) {
          return -1;
            ...
            return (<string>arr).lastIndexOf((<string>obj), fromIndex);
        }
      }
  ...
  export function forEach<T, S>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: T, arg2: number, arg3: any) => any)|null,
      opt_obj?: S|undefined) {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
    ...
    if (bo) {
      ...
      var arr2 = goog.isString(arr) ? (<string>arr).split('') : arr;
      for (var i = 0; i < l; i++) {
        if (i in <IArrayLike<any>>arr2) {
   ...
   * @template T,S
   */
  export function forEachRight<T, S>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: T, arg2: number, arg3: any) => any)|null,
      opt_obj?: S|undefined) {
    var l = arr.length;  // must be fixed during loop... see docs
  ...
  export function filter<T, S>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: T, arg2: number, arg3?: any) => boolean)|null,
      opt_obj?: S|undefined): Array<T> {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
   ...
   */
  export function map<THIS, VALUE, RESULT>(
      arr: IArrayLike<VALUE>|string,
      f: (this: THIS, arg1: VALUE, arg2: number, arg3: any) => RESULT,
      opt_obj?: THIS|undefined): Array<RESULT> {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
   ...
   * @template T,S,R
   */
  export function reduce<T, S, R>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: R, arg2: T, arg3: number, arg4: any) => R), val: any,
      opt_obj?: S): R {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
   ...
   * @template T,S,R
   */
  export function reduceRight<T, S, R>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: R, arg2: T, arg3: number, arg4: any) => R)|null,
      val: any, opt_obj?: S|undefined): R {
    var bo = goog.NATIVE_ARRAY_PROTOTYPES &&
  ...
  export function some<T, S>(
    ...
    if (bo) {
      ...
      var arr2 = goog.isString(arr) ? (<string>arr).split('') : arr;
      for (var i = 0; i < l; i++) {
        if (i in <IArrayLike<any>>arr2 && f.call(/** @type {?} */ (opt_obj), arr2[i], i, arr)) {
          return true;
        }
      }
      return false;
   ...
   * @template T,S
   */
  export function count<T, S>(
      arr: IArrayLike<T>|string,
      f: (this: S, arg1: T, arg2: number, arg3: any) => boolean,
      opt_obj?: S|undefined): number {
    var count = 0;
  ...
  export function find<T, S>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: T, arg2: number, arg3: any) => boolean)|null,
      opt_obj?: S|undefined): T|null {
    var i = goog.array.findIndex(arr, f, opt_obj);
    return i < 0 ? null : goog.isString(arr) ? (<string>arr).charAt(i) : arr[i];
  };
   ...
   * @template T,S
   */
  export function findIndexRight<T, S>(
      arr: IArrayLike<T>|string,
      f: ((this: S, arg1: T, arg2: number, arg3: any) => boolean)|null,
      opt_obj?: S|undefined): number {
    var l = arr.length;  // must be fixed during loop... see docs
   ...
   */
  export function contains(arr: IArrayLike<any>|string, obj: any): boolean {
   ...
   */
  export function isEmpty(arr: IArrayLike<any>|string): boolean {
    return arr.length == 0;
  };
   ...
   */
  export function clear(arr: IArrayLike<any>) {
   ...
   * @template T
   */
  export function insert<T>(arr: Array<T>, obj: T) {
  ...
  export function insertAt(
      arr: IArrayLike<any>, obj: any, opt_i?: number|undefined) {
   ...
   *      treated as 0. A negative index is counted from the end of the array.
   */
  export function insertArrayAt(
      arr: IArrayLike<any>, elementsToAdd: IArrayLike<any>,
      opt_i?: number|undefined) {
  ...
  export function insertBefore<T>(
      arr: Array<T>, obj: T, opt_obj2?: T|undefined) {
    var i;
   ...
   * @template T
   */
  export function remove<T>(arr: IArrayLike<T>, obj: T): boolean {
   ...
   * @template T
   */
  export function removeLast<T>(arr: IArrayLike<T>, obj: T): boolean {
   ...
   * @return {boolean} True if an element was removed.
   */
  export function removeAt(arr: IArrayLike<any>, i: number): boolean {
    goog.asserts.assert(arr.length != null);
   ...
   * @template T,S
   */
  export function removeAllIf<T, S>(
      arr: IArrayLike<T>,
      f: ((this: S, arg1: T, arg2: number, arg3: any) => boolean)|null,
      opt_obj?: S|undefined): number {
    var removedCount = 0;
   ...
   * @template T
   */
  export function join<T>(...var_args: Array<T>[]): Array<T> {
    return Array.prototype.concat.apply([], arguments);
  };
   ...
   * @template T
   */
  export function toArray<T>(object: IArrayLike<T>|string): Array<T> {
   ...
   * @template T
   */
  export function clone<T>(arr: IArrayLike<T>|string): Array<T> {
  ...
  export function extend<VALUE>(
      arr1: Array<VALUE>, ...var_args: (IArrayLike<VALUE>|VALUE)[]) {
  ...
  export function splice<T>(
      arr: IArrayLike<T>, index: number|undefined, howMany: number,
      ...var_args: T[]): Array<T> {
    goog.asserts.assert(arr.length != null);
  ...
  export function slice<T>(
      arr: IArrayLike<T>|string, start: number,
      opt_end?: number|undefined): Array<T> {
    goog.asserts.assert(arr.length != null);
  ...
  export function removeDuplicates<T>(
      arr: IArrayLike<T>, opt_rv: Array<any>|undefined,
      opt_hashFn?: (arg0: T) => string) {
   ...
   */
  export function binarySearch<TARGET, VALUE>(
      arr: IArrayLike<VALUE>, target: TARGET,
      opt_compareFn?: (arg0: TARGET, arg1: VALUE) => number): number {
    return goog.array.binarySearch_(
        arr, opt_compareFn || goog.array.defaultCompare,
        false /* isEvaluator */, target);
  };
   ...
   * @template THIS, VALUE
   */
  export function binarySelect<THIS, VALUE>(
      arr: IArrayLike<VALUE>,
      evaluator: (this: THIS, arg1: VALUE, arg2: number, arg3: any) => number,
      opt_obj?: THIS|undefined): number {
        var adapter:any = opt_obj;
        return goog.array.binarySearch_(
   ...
   * @private
   */
  export function binarySearch_(
      arr: IArrayLike<any>,
      compareFn: (arg0: any, arg1: any, arg2?: any) => number,
      isEvaluator: boolean, opt_target?: any|undefined,
      opt_selfObj?: object|undefined): number {
  ...
  export function sort<T>(
      arr: Array<T>, opt_compareFn?: ((arg0: T, arg1: T) => number)|null) {
  ...
  export function sortByKey<T, K>(
      arr: Array<T>, keyFn: (arg0: T) => K,
      opt_compareFn?: ((arg0: K, arg1: K) => number)|null) {
  ...
  export function sortObjectsByKey(
      arr: Array<object>, key: string, opt_compareFn?: Function|undefined) {
        var adapter:any = opt_compareFn;
  ...
  export function isSorted<T>(
      arr: IArrayLike<T>, opt_compareFn?: ((arg0: T, arg1: T) => number)|null,
      opt_strict?: boolean|undefined): boolean {
  ...
  export function equals(
      arr1: IArrayLike<any>, arr2: IArrayLike<any>,
      opt_equalsFn?: Function|undefined): boolean {
   ...
   * @template VALUE
   */
  export function compare3<VALUE>(
      arr1: IArrayLike<VALUE>, arr2: IArrayLike<VALUE>,
      opt_compareFn?: (arg0: VALUE, arg1: VALUE) => number): number {
    var compare = opt_compareFn || goog.array.defaultCompare;
   ...
   * @template VALUE
   */
  export function binaryInsert<VALUE>(
      array: IArrayLike<VALUE>, value: VALUE,
      opt_compareFn?: (arg0: VALUE, arg1: VALUE) => number): boolean {
   ...
   * @template VALUE
   */
  export function binaryRemove<VALUE>(
      array: IArrayLike<VALUE>, value: VALUE,
      opt_compareFn?: (arg0: VALUE, arg1: VALUE) => number): boolean {
    var index = goog.array.binarySearch(array, value, opt_compareFn);
   ...
   * @template T,S
   */
  export function bucket<T, S>(
      array: IArrayLike<T>,
      sorter: (this: S, arg1: T, arg2: number, arg3: IArrayLike<T>) => any,
      opt_obj?: S|undefined): Object {
    var buckets = {};
   ...
   * @template T,S
   */
  export function toObject<T, S>(
      arr: IArrayLike<T>,
      keyFunc: ((this: S, arg1: T, arg2: number, arg3: any) => string)|null,
      opt_obj?: S|undefined): Object {
    var ret = {};
  ...
  export function range(
      startOrEnd: number, opt_end?: number|undefined,
      opt_step?: number|undefined): Array<number> {
    var array = [];
    var start = 0;
    var end = startOrEnd;
    var step = opt_step || 1;
   ...
   * @template VALUE
   */
  export function repeat<VALUE>(value: VALUE, n: number): Array<VALUE> {
    var array = [];
    for (var i = 0; i < n; i++) {
      array[i] = value;
    }
   ...
   * @template T
   */
  export function rotate<T>(array: Array<T>, n: number): Array<T> {
  ...
  export function moveItem(
      arr: IArrayLike<any>, fromIndex: number, toIndex: number) {
   ...
   *     provided arrays.
   */
  export function zip(...var_args: IArrayLike<any>[]): Array<Array<any>> {
    if (!arguments.length) {
      return [];
    }
    var result = [];
   ...
   */
  export function shuffle(arr: Array<any>, opt_randFn?: () => number) {
   ...
   * @template T
   */
  export function copyByIndex<T>(
      arr: IArrayLike<T>, index_arr: IArrayLike<number>): Array<T> {
    var result = [];
   ...
   * @template THIS, VALUE, RESULT
   */
  export function concatMap<THIS, VALUE, RESULT>(
      arr: IArrayLike<VALUE>|string,
      f: (this: THIS, arg1: VALUE, arg2: number, arg3: any) => Array<RESULT>,
      opt_obj?: THIS|undefined): Array<RESULT> {
