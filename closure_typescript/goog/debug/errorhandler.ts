...
namespace goog.debug{
  export class ErrorHandler extends goog.Disposable implements goog.debug.EntryPointMonitor{

      errorHandlerFn_: Function;
      wrapErrors_: boolean;  // TODO(user) Change default.
     ...
     * @private
     */
    addTracersToProtectedFunctions_ = false;

    /**
     * Enable tracers when instrumenting entry points.
     * @param {boolean} newVal See above.
     */
    public setAddTracersToProtectedFunctions(
      newVal) {
     ...
     * @private
     */
    public getStackTraceHolder_(stackTrace) {
      var buffer = [];
     ...
     * @private
     */
    public getFunctionIndex_(wrapper) {
     ...
     * @protected
     */
    public getProtectedFunction(fn) {
      var that = this;
     ...
     */
    public protectWindowSetTimeout() {
     ...
     */
    public protectWindowSetInterval() {
     ...
     * exceptions.
     */
    public protectWindowRequestAnimationFrame =
        function() {
     ...
     * @private
     */
    public protectWindowFunctionsHelper_(
        fnName) {
      var win = goog.getObjectByName('window');
     ...
     */
    public setWrapErrors(wrapErrors) {
...
namespace goog.debug.ErrorHandler{
  export class ProtectedFunctionError extends goog.debug.Error{
     ...
     * @type {string}
     */
    static MESSAGE_PREFIX = 'Error in protected function: ';
  }
}
