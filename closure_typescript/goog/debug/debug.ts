...
namespace goog.debug{
  export var LOGGING_ENABLED = goog.DEBUG;
  export var FORCE_SLOPPY_STACKS = false;
   ...
   */
  export function catchErrors(logFunc: Function, opt_cancel?: boolean | undefined, opt_target?: object | undefined) {
    var target:any = opt_target || goog.global;
     ...
     */
    target.onerror = function (message: string, url: string, line: number, opt_col: number | undefined, opt_error: Error | undefined): boolean
    {
      if (oldErrorHandler) {
   ...
   */
  export function expose(obj: object | null | undefined, opt_showFn?: boolean | undefined): string {
   ...
   *     it is converted to an Error which is enhanced and returned.
   */
  export function enhanceErrorWithContext(err: any, opt_context?: { [s: string]: string; } | undefined): Error {
   ...
   * @suppress {es5Strict}
   */
  export function getStacktraceSimple(opt_depth?: number | undefined): string {
   ...
   * @private
   */
  export function getNativeStackTrace_(fn: Function): string | null {
   ...
   * @suppress {es5Strict}
   */
  export function getStacktrace(fn: (Function | undefined) | null): string {
    var stack;
    if (!goog.debug.FORCE_SLOPPY_STACKS) {
   ...
   * @private
   */
  export function getStacktraceHelper_(fn: Function | null, visited: Array<Function>): string {
    var sb = [];
   ...
   *     names.
   */
  export function setFunctionResolver(resolver: (arg0: Function) => string) {
   ...
   * @private
   */
  export function freezeInternal_<T>(arg: T): T {
    if (goog.DEBUG) {
