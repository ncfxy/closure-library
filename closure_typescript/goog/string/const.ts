...
namespace goog.string{
    export class Const implements goog.string.TypedString{
        public stringConstValueWithSecurityContract__googStringSecurityPrivate_;
        public STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_;
...
namespace goog.string.Const{
     ...
     */
    export function unwrap(stringConst) {
     ...
     * @private
     */
    export function create__googStringSecurityPrivate_(s) {
     ...
     */
    export var EMPTY = goog.string.Const.from('');
}
