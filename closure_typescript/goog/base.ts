...
namespace goog.global{

    // inherit from window;
    export var addEventListener = window.addEventListener;
    export var removeEventListener = window.removeEventListener;
    ...
    export var CLOSURE_UNCOMPILED_DEFINES;
    export var CLOSURE_DEFINES;
    export var navigator: Navigator;
    export var atob:any;
    export var JSON;
    export var URL;
    export var webkitURL;
    export var createObjectURL;
    export var requestFileSystem;
    export var webkitRequestFileSystem;
    export var BlobBuilder;
    export var WebKitBlobBuilder;
    
    /**
     * A hook for overriding the base path.
     * @type {string|undefined}
     */
    export var CLOSURE_BASE_PATH;
     ...
     */
    export var CLOSURE_IMPORT_SCRIPT;
     ...
     */
    export var CLOSURE_LOAD_FILE_SYNC;
     ...
     * @type {(function(string):string)|undefined}
     */
    export var CLOSURE_CSS_NAME_MAP_FN;
     ...
     */
    export var CLOSURE_CSS_NAME_MAPPING;

    export var document;
    export var console;

    export function execScript(a:string, b:string){

    }

    export function eval(a:string){
...
namespace goog{
     ...
     * @private
     */
    export function exportPath_(name: string, opt_object?, opt_objectToExportTo?: object | undefined) {
        var parts = name.split('.');
        var cur:{execScript?:Function} = opt_objectToExportTo || goog.global;
     ...
     */
    export function define(name: string, defaultValue: string | number | boolean) {
    ...
    export var STRICT_MODE_COMPATIBLE = false;
    ...
    export var DISALLOW_TEST_ONLY_CODE = COMPILED && !goog.DEBUG;
    ...
    export var ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING = false;
     ...
     * @private
     */
    export function constructNamespace_(name: string, opt_obj?: object | undefined) {
        if(!COMPILED) {
     ...
     * @private
     */
    export var VALID_MODULE_RE_ = /^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
    ...
    export namespace module{
         ...
         * @private
         */
        export function getInternal_(name){
            if(!COMPILED) {
         ...
         * @suppress {missingProvide}
         */
        export function declareLegacyNamespace() {
    ...
    export var loadedModules_;
    export var implicitNamespaces_;

    /**
     * @private {?{moduleName: (string|undefined), declareLegacyNamespace:boolean}}
     */
    export var moduleLoaderState_:{moduleName:string|undefined, declareLegacyNamespace:boolean} = null;
     
    /**
     * @private
     * @return {boolean} Whether a goog.module is currently being initialized.
     */
    export function isInModuleLoader_() {
     ...
     */
    export function setTestOnly(opt_message?:string){
     ...
     *     "goog.package.part".
     */
    export function forwardDeclare(name) {
     ...
     */
    export function getObjectByName(name:string, opt_obj?:string):any {
        var parts = name.split('.');
     ...
     */
    export function globalize(obj:Object, opt_global?:Object) {
     ...
     */
    export function addDependency(relPath, provides, requires, opt_loadFlags) {
     ...
     * @private
     */
    export function logToConsole_(msg:string){
     ...
     *     method to.
     */
    export function addSingletonGetter(ctor:any) {
     ...
     * @private
     */
    export var instantiatedSingletons_ = [];
     ...
     * @const {boolean}
     */
    export var DEPENDENCIES_ENABLED = !COMPILED && goog.ENABLE_DEBUG_LOADER;
    
    /**
     * @package {?boolean}
     * Visible for testing.
     */
    export var hasBadLetScoping = null;

    /**
     * @return {boolean}
     * @package Visible for testing.
     */
    export function useSafari10Workaround() {
     ...
     * @package Visible for testing.
     */
    export function workaroundSafari10EvalBug(moduleDef) {
     ...
     */
    export function loadModule(moduleDef) {
     ...
     * @private @const
     */
    export function loadModuleFromSource_() {
     ...
     * @private
     */
    export function normalizePath_(path) {
     ...
     * @private
     */
    export function loadFileSync_(src) {
     ...
     * @private
     */
    export function transpile_(code, path) {
     ...
     * @private
     */
    export var UID_PROPERTY_ = 'closure_uid_' + ((Math.random() * 1e9) >>> 0);
     ...
     */
    export var getHashCode = goog.getUid;
     ...
     */
    export var removeHashCode = goog.removeUid;
     ...
     */
    export function bind(fn, selfObj, ...var_args) {
    ...
    export function now():number{
        ...
        return <number>(goog.TRUSTED_SITE && Date.now || +new Date());
    }
     ...
     */
    export function globalEval(script) {
     ...
     * @private
     */
    export var evalWorksForGlobals_ = null;
     ...
     * @see goog.setCssNameMapping
     */
    export var cssNameMappingStyle_;
     ...
     */
    export function setCssNameMapping(mapping, opt_style) {
     ...
     *     is goog.global.
     */
    export function exportSymbol(publicPath, object, opt_objectToExportTo) {
     ...
     */
    export function inherits(childCtor, parentCtor:Function) {
        /** @constructor */
        function tempCtor() {}
     ...
     */
    export function defineClass (superClass, def) {
    ...
    export namespace defineClass {
        export var ClassDescriptor:any;
        export var SEAL_CLASS_INSTANCES;
         ...
         * @private
         */
        export function createSealingConstructor_(ctr, superClass) {
         ...
         * @private
         */
        export function isUnsealable_(ctr) {
         ...
         * @const
         */
        export var OBJECT_PROTOTYPE_FIELDS_ = [
         ...
         * @private
         */
        export function applyProperties_(target, source) {
     ...
     */
    export function tagUnsealableClass(ctr) {
     ...
     */
    export var UNSEALABLE_CONSTRUCTOR_PROPERTY_ = 'goog_defineClass_legacy_unsealable';
...
// if (!COMPILED) {
    namespace goog{
         ...
         * @private
         */
        export function isProvided_(name){
         ...
         * @private
         */
        export var implicitNamespaces_:any = {'goog.module': true};
    }
...
namespace goog{
    export var ENABLE_DEBUG_LOADER =  true;
    export var LOAD_MODULE_USING_EVAL =  true;
    export var SEAL_MODULE_EXPORTS =  goog.DEBUG;
    export var TRANSPILE =  'detect';
    export var TRANSPILER =  'transpile.js';
    export var DEBUG_LOADER =  '';
}
...
// if(goog.DEPENDENCIES_ENABLED){
    namespace goog{
         ...
         * @private
         */
        export function inHtmlDocument_() {
            /** @type {!Document} */
            var doc = goog.global.document;
    ...
    export function findBasePath_ () {
        ...
        if (currentScript) {
          ...
          var scripts:any[] = doc.getElementsByTagName('SCRIPT');
        }
      ...
      export class Transpiler{
          private requiresTranspilation_:Object;
      ...
      export class DebugLoader{
          private dependencies_:any;
          private oldIeWaiting_:any;
          private queuedModules_:any;
          private lastNonModuleScriptIndex_:any;
          /**
          ...
          /**
             ...
             * @private
             */
            private importScript_(src: string, opt_sourceText?: string) {
             ...
             * @private
             */
            private importProcessedScript_(
             ...
             * @protected @final
             */
            protected isProvided(namespaceOrPath) {
             ...
             * @protected @final
             */
            protected logToConsole(message) {
      ...
      export var debugLoader_ = null;
      /** @param {!goog.DebugLoader} loader */
        export function registerDebugLoader(loader){
