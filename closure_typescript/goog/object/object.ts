...
namespace goog.object{
     ...
     * @template T,K,V
     */
    export function forEach<T, K, V>(obj, f: (this: T, arg1: V, arg2: any, arg3) =>any, opt_obj?: T | undefined) {
        for (var key in obj) {
     ...
     * @template T,K,V
     */
    export function filter(obj, f, opt_obj?) {
        var res = {};
        for (var key in obj) {
     ...
     * @template T,K,V,R
     */
    export function map(obj, f, opt_obj?) {
        var res = {};
        for (var key in obj) {
     ...
     * @template T,K,V
     */
    export function some(obj, f, opt_obj?) {
        for (var key in obj) {
        if (f.call(/** @type {?} */ (opt_obj), obj[key], key, obj)) {
            return true;
        }
     ...
     * @template K,V
     */
    export function getAnyValue(obj) {
        for (var key in obj) {
        return obj[key];
        }
    };
     ...
     * @template K,V
     */
    export function contains(obj, val) {
     ...
     */
    export function getValueByKeys(obj: object, ...var_args): any {
     ...
     * @template K,V
     */
    export function containsValue(obj, val) {
        for (var key in obj) {
        if (obj[key] == val) {
            return true;
        }
     ...
     * @template T,K,V
     */
    export function findKey(obj, f, opt_this?) {
        for (var key in obj) {
     ...
     * @template T,K,V
     */
    export function findValue(obj, f, opt_this?) {
     ...
     */
    export function clear(obj: object) {
        for (var i in obj) {
            delete obj[i];
        }
    };
     ...
     * @template K,V
     */
    export function add(obj, key, val) {
     ...
     * @template K,V,R
     */
    export function get(obj, key, opt_val?) {
        if (obj !== null && key in obj) {
        return obj[key];
        }
        return opt_val;
     ...
     * @template K,V
     */
    export function setIfUndefined(obj, key, value) {
     ...
     * @template K,V
     */
    export function setWithReturnValueIfNotSet(obj, key, f) {
        if (key in obj) {
        return obj[key];
        }
     ...
     * @private
     */
    export var PROTOTYPE_FIELDS_:Array<string> = [
     ...
     * @return {!Object} The new object.
     */
    export function createSet(...var_args) {
        var argLength = arguments.length;
        if (argLength == 1 && goog.isArray(arguments[0])) {
     ...
     * @template K,V
     */
    export function createImmutableView(obj) {
        var result = obj;
     ...
     */
    export function isImmutableView(obj) {
