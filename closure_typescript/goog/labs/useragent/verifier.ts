...
namespace goog.labs.useragent.verifier{
  /** @const */
  export const NOT_IE = 0;
   ...
   * @return {number}
   */
  export function detectIeVersionByBehavior() {
    if (document.all) {
   ...
   * @return {number}
   */
  export function detectIeVersionByNavigator () {
   ...
   * @return {number}
   */
  export function getCorrectedIEVersionByNavigator () {
