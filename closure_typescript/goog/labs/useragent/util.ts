...
namespace goog.labs.userAgent.util{
   ...
   * @private
   */
  export function getNativeUserAgentString_(): string {
   ...
   * @private
   */
  export function getNavigator_(): Navigator {
   ...
   * @private {string}
   */
  export var userAgent_ = goog.labs.userAgent.util.getNativeUserAgentString_();
   ...
   */
  export function setUserAgent(opt_userAgent?: (string | undefined) | null) {
