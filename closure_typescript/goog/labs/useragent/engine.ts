...
namespace goog.labs.userAgent.engine{
   ...
   * @private
   */
  export function getEngineTuple_(tuples: Array<Array<string>>): Array<string> | undefined {
   ...
   * @private
   */
  export function getVersionForKey_(tuples: Array<Array<string>>, key: string): string {
