...
namespace goog.events.KeyCodes{
   ...
   */
  export function isTextModifyingKeyEvent(e) {
   ...
   */
  export function firesKeyPressEvent(
   ...
   */
  export function normalizeKeyCode(keyCode) {
   ...
   * @return {number} The normalized key code.
   */
  export function normalizeGeckoKeyCode(keyCode) {
    switch (keyCode) {
      case goog.events.KeyCodes.FF_EQUALS:
   ...
   * @return {number} The normalized key code.
   */
  export function normalizeMacWebKitKeyCode(keyCode) {
    switch (keyCode) {
