...
namespace goog.events{
  export class BrowserEvent extends goog.events.Event{
     ...
     * @param {EventTarget=} opt_currentTarget Current target for event.
     */
    public init(e, opt_currentTarget) {
...
namespace goog.events.BrowserEvent{
   ...
   */
  export var IEButtonMap = goog.debug.freeze([
    1,  // LEFT
    4,  // MIDDLE
    2   // RIGHT
  ]);
   ...
   * @const {!Array<number>}
   */
  export var IE_BUTTON_MAP = goog.events.BrowserEvent.IEButtonMap;
   ...
   */
  export const IE_POINTER_TYPE_MAP = goog.debug.freeze({
   ...
   * @private
   */
  export function getPointerType_(e) {
