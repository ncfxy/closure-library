...
namespace goog.events.Listenable{
   ...
   * @const
   */
  export var IMPLEMENTED_BY_PROP =
   ...
   */
  export function addImplementation(cls) {
...
namespace goog.events.ListenableKey{
