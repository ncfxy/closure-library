...
namespace goog.structs{
  export class Map<K,V>{
     ...
     */
    public equals(otherMap, opt_equalityFn?) {
      if (this === otherMap) {
        return true;
      }
