...
namespace goog.dom.safe{



  /** @enum {string} */
  export enum InsertAdjacentHtmlPosition {
   ...
   */
  export var  SET_INNER_HTML_DISALLOWED_TAGS_  = {
    'MATH': true,
    'SCRIPT': true,
    'STYLE': true,
    'SVG': true,
  ...
  export function setButtonFormAction(button, url) {
    ...
    (<any>goog.dom.asserts.assertIsHTMLButtonElement(button)).formaction =
        goog.html.SafeUrl.unwrap(safeUrl);
  };
  /**
  ...
  export function setInputFormAction(input, url) {
    ...
    (<any>goog.dom.asserts.assertIsHTMLInputElement(input)).formaction =
        goog.html.SafeUrl.unwrap(safeUrl);
  };
   ...
   * @see goog.html.SafeUrl#sanitize
   */
  export function setImageSrc(imageElement, url) {
