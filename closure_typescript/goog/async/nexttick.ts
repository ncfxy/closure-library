...
namespace goog.async.nextTick{
   ...
   * @private
   */
  export function useSetImmediate_ () {
   ...
   * @private
   */
  export function getSetImmediateEmulator_() {
    ...
    if (typeof Channel === 'undefined' && typeof window !== 'undefined' &&
      ...
      Channel = function() {
        ...
        var iframe = /** @type {!HTMLIFrameElement} */ (
            <HTMLIFrameElement>document.createElement(String(goog.dom.TagName.IFRAME)));
    ...
    if (typeof Channel !== 'undefined' && !goog.labs.userAgent.browser.isIE()) {
      ...
      var head:{next?:Object, cb?:Function} = {};
      var tail = head;
    ...
    if (typeof document !== 'undefined' &&
      ...
      return function(cb) {
        var script = <any>document.createElement(String(goog.dom.TagName.SCRIPT));
   ...
   * @private
   */
  export var wrapCallback_:any = goog.functions.identity;
}
...
goog.debug.entryPointRegistry.register(
     ...
     *     function.
     */
    function (transformer: (arg0: Function) => Function) { goog.async.nextTick.wrapCallback_ = transformer; });
