...
namespace goog.async{
   ...
   * @template THIS
   */
  export function run<THIS>(callback: (this: THIS) => void , opt_context?: THIS) {
...
namespace goog.async.run{
  
  /**
   * Initializes the function to use to process the work queue.
   * @private
   */
  export function initializeRunner_() {
   ...
   */
  export function forceNextTick(opt_realSetTimeout?) {
    goog.async.run.schedule_ = function() {
      goog.async.nextTick(goog.async.run.processWorkQueue);
   ...
   * @private {function()}
   */
  export var schedule_;


  /** @private {boolean} */
  export var workQueueScheduled_ = false;


  /** @private {!goog.async.WorkQueue} */
  export var workQueue_ = new goog.async.WorkQueue();
