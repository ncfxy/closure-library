...
namespace goog.html{
   ...
   */
  export class SafeStyle implements goog.string.TypedString{
    private privateDoNotAccessOrElseSafeStyleWrappedValue_: string;
    private SAFE_STYLE_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_:Object;
    /**
     * @override
     * @const
     */
     ...
     * @const {string}
     */
    static INNOCUOUS_STRING = 'zClosurez';
     ...
     * @private {string}
     */
    static VALUE_ALLOWED_CHARS_ = '[-,."\'%_!# a-zA-Z0-9]';
     ...
     * @private @const {!RegExp}
     */
    static FUNCTIONS_RE_ = new RegExp(
