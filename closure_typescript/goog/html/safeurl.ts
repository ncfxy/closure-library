...
namespace goog.html{
  export class SafeUrl implements goog.string.TypedString, goog.i18n.bidi.DirectionalString{
    public privateDoNotAccessOrElseSafeHtmlWrappedValue_:string;
    public SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_;
    /**
     ...
     * @const
     */
    public implementsGoogStringTypedString = true;
     ...
     * @const
     */
    public implementsGoogI18nBidiDirectionalString = true;
...
namespace goog.html.SafeUrl{
  export var FUNCTIONS_RE_;
  export var URL_RE_;
   ...
   * @const {string}
   */
  export var INNOCUOUS_STRING = 'about:invalid#zClosurez';
   ...
   */
  export function unwrap (safeUrl) {
   ...
   */
  export function fromConstant (url) {
   ...
   *     wrapped as a SafeUrl if it does not pass.
   */
  export function fromTelUrl(telUrl) {
   ...
   */
  export function fromTrustedResourceUrl(trustedResourceUrl) {
    return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(
   ...
   * @return {!goog.html.SafeUrl} The validated URL, wrapped as a SafeUrl.
   */
  export function sanitizeAssertUnchanged(url) {
    if (url instanceof goog.html.SafeUrl) {
      return url;
    } else if (url.implementsGoogStringTypedString) {
      url = url.getTypedStringValue();
   ...
   * @private
   */
  export var TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ = {};
   ...
   * @package
   */
  export function createSafeUrlSecurityPrivateDoNotAccessOrElse(
      url) {
...
namespace goog.html{
   ...
   * @private
   */
  export var SAFE_MIME_TYPE_PATTERN_ = new RegExp(
   ...
   * @private
   */
  export var DATA_URL_PATTERN_ = /^data:([^;,]*);base64,[a-z0-9+\/]+=*$/i;
