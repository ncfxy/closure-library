...
namespace goog.html{
  ...
  */
  export class SafeStyleSheet implements goog.string.TypedString{
    private privateDoNotAccessOrElseSafeStyleSheetWrappedValue_:string;
    private SAFE_STYLE_SHEET_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_: Object;
    /**
     * @override
     * @const
     */
     ...
     * @private
     */
    public initSecurityPrivateDoNotAccessOrElse_ (styleSheet) {
