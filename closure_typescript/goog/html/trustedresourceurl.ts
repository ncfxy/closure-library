...
namespace goog.html{
  export class TrustedResourceUrl implements goog.i18n.bidi.DirectionalString, goog.string.TypedString{
    public privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_;
    public TRUSTED_RESOURCE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_;
    /**
     ...
     * @const
     */
    public implementsGoogI18nBidiDirectionalString =
        true;
...
namespace goog.html.TrustedResourceUrl{
   ...
   */
  export function unwrap(trustedResourceUrl) {
   ...
   *     the format string is not present in args.
   */
  export function formatWithParams(format, args, params) {
   ...
   */
  export function fromConstants(parts) {
    var unwrapped = '';
   ...
   * @package
   */
  export function createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(url) {
