...
namespace goog.html.uncheckedconversions {
  ...
  export function safeHtmlFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const, html: string,
      opt_dir?: (goog.i18n.bidi.Dir|undefined)|null): goog.html.SafeHtml {
   ...
   *     SafeScript object.
   */
  export function safeScriptFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const, script: string): goog.html.SafeScript {
    // unwrap() called inside an assert so that justification can be optimized
    // away in production code.
    goog.asserts.assertString(
        goog.string.Const.unwrap(justification), 'must provide justification');
   ...
   *     SafeStyle object.
   */
  export function safeStyleFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const, style: string): goog.html.SafeStyle {
    // unwrap() called inside an assert so that justification can be optimized
    // away in production code.
    goog.asserts.assertString(
        goog.string.Const.unwrap(justification), 'must provide justification');
   ...
   */
  export function safeStyleSheetFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const,
      styleSheet: string): goog.html.SafeStyleSheet {
    // unwrap() called inside an assert so that justification can be optimized
    // away in production code.
    goog.asserts.assertString(
        goog.string.Const.unwrap(justification), 'must provide justification');
   ...
   *     object.
   */
  export function safeUrlFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const, url: string): goog.html.SafeUrl {
    // unwrap() called inside an assert so that justification can be optimized
    // away in production code.
    goog.asserts.assertString(
        goog.string.Const.unwrap(justification), 'must provide justification');
   ...
   */
  export function trustedResourceUrlFromStringKnownToSatisfyTypeContract(
      justification: goog.string.Const,
      url: string): goog.html.TrustedResourceUrl {
    // unwrap() called inside an assert so that justification can be optimized
    // away in production code.
    goog.asserts.assertString(
        goog.string.Const.unwrap(justification), 'must provide justification');
