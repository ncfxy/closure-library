...
namespace goog.html{
   ...
   */
  export class SafeHtml implements goog.i18n.bidi.DirectionalString, goog.string.TypedString {
     ...
     * @const
     */
    implementsGoogI18nBidiDirectionalString = true;
     ...
     */
    static from = goog.html.SafeHtml.htmlEscape;
     ...
     * @private
     */
    static VALID_NAMES_IN_TAG_ = /^[a-zA-Z0-9-]+$/;
     ...
     */
    static URL_ATTRIBUTES_ = goog.object.createSet(
     ...
     * @private @const {!Object<string,boolean>}
     */
    static NOT_ALLOWED_TAG_NAMES_ = goog.object.createSet(
