...
namespace goog.ui{
    ...
    export class Component extends goog.events.EventTarget{
        ...
        private rightToLeft_: boolean;
        private id_:string;
        private inDocument_:boolean;
        private element_:Element;
        private googUiComponentHandler_: goog.events.EventHandler<void> | undefined;
        private model_: any;
        private parent_: goog.ui.Component;
        private children_: Array<goog.ui.Component>;
        private childIndex_: {[index:string]:Object};
        private wasDecorated_: boolean;
         ...
         */
        public static getStateTransitionEvent(state: goog.ui.Component.State, isEntering: boolean): goog.ui.Component.EventType {
            switch (state) {
         ...
         */
        public static setDefaultRightToLeft(rightToLeft?: boolean) {
         ...
         * @return {!Element} The element for the component.
         */
        public getElementStrict(): Element {
         ...
         */
        public setElementInternal(element: Element) {
         ...
         */
        public getElementsByClass(className: string): IArrayLike<Element> {
            return this.element_ ?
         ...
         */
        public getElementByClass(className: string): Element {
         ...
         * @return {!Element} The first item with the class name provided.
         */
        public getRequiredElementByClass(className: string): Element {
         ...
         * @template T
         */
        protected getHandler<T>(): goog.events.EventHandler<T> {
            ...
            return <goog.events.EventHandler<T>>self.googUiComponentHandler_;
        };
         ...
         */
        public setParent(parent: goog.ui.Component) {
            if (this == parent) {
         ...
         */
        public getParent(): goog.ui.Component | null {
            return this.parent_;
        };
         ...
         */
        public getDomHelper(): goog.dom.DomHelper {
            return this.dom_;
        };
         ...
         *    component into.
         */
        public render(opt_parentElement?: Element | undefined) {
         ...
         */
        public renderBefore(sibling: Node) {
            this.render_(/** @type {Element} */(<Element>sibling.parentNode), sibling);
        };
         ...
         * @private
         */
        private render_(opt_parentElement?: Element | undefined, opt_beforeNode?: Node | undefined) {
            if (this.inDocument_) {
         ...
         */
        public decorate(element: Element) {
            if (this.inDocument_) {
                throw new Error(goog.ui.Component.Error.ALREADY_RENDERED);
            }
         ...
         */
        public canDecorate(element: Element): boolean {
            return true;
        };
         ...
         * @protected
         */
        public decorateInternal(element: Element) {
            this.element_ = element;
        };
         ...
         */
        public makeId(idFragment: string): string {
         ...
         */
        public makeIds(object: object): { [s: string]: string; } {
            var ids = {};
         ...
         */
        public getFragmentFromId(id: string): string {
         ...
         *     found.
         */
        public getElementByFragment(idFragment: string): Element {
            if (!this.inDocument_) {
         ...
         *    into the parent.
         */
        public addChild(child: goog.ui.Component, opt_render?: boolean | undefined) {
         ...
         * @return {void} Nada.
         */
        public addChildAt(child: goog.ui.Component, index: number, opt_render?: boolean | undefined): void {
         ...
         *     right-to-left.
         */
        public setRightToLeft(rightToLeft: boolean) {
            if (this.inDocument_) {
                throw new Error(goog.ui.Component.Error.ALREADY_RENDERED);
            }
         ...
         */
        public getChildIds(): Array<string> {
            var ids = [];
         ...
         */
        public getChild(id: string): goog.ui.Component | null {
         ...
         */
        public getChildAt(index: number): goog.ui.Component | null {
         ...
         * @template T
         */
        public forEachChild<T>(f: (this: T, arg1: any, arg2: number) =>any, opt_obj?: T | undefined) {
            if (this.children_) {
         ...
         */
        public indexOfChild(child: goog.ui.Component | null): number {
         ...
         */
        public removeChild(child: string | goog.ui.Component | null, opt_unrender?: boolean | undefined): goog.ui.Component {
            if (child) {
                // Normalize child to be the object and id to be the ID string.  This also
                // ensures that the child is really ours.
                var id = goog.isString(child) ? child : (<goog.ui.Component>child).getId();
                child = this.getChild(<string>id);
                if (id && child) {
            ...
            return /** @type {!goog.ui.Component} */ <goog.ui.Component>(child);
        };
         ...
         * @return {goog.ui.Component} The removed component, if any.
         */
        public removeChildAt(index: number, opt_unrender?: boolean | undefined): goog.ui.Component {
         ...
         */
        public removeChildren(opt_unrender?: boolean | undefined): Array<goog.ui.Component> {
            var removedChildren = [];
...
namespace goog.ui.Component{
     ...
     * @private
     */
    export var defaultRightToLeft_ =
    (goog.ui.Component.DEFAULT_BIDI_DIR == 1) ?
    false :
    (goog.ui.Component.DEFAULT_BIDI_DIR == -1) ? true : null;

    export var ALLOW_DETACHED_DECORATION;
    export var DEFAULT_BIDI_DIR;
    export var superClass_:any;
