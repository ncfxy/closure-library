...
namespace goog{
  ...
  export interface Thenable<TYPE> extends IThenable<TYPE>{
     ...
     *
     */
    then<VALUE, THIS, RESULT>(opt_onFulfilled?: (this:THIS, TYPE) => VALUE, opt_onRejected?:(this:THIS, any) => any, opt_context?:THIS): RESULT;
...
namespace goog.Thenable{
   ...
   * @const
   */
  export const IMPLEMENTED_BY_PROP = '$goog_Thenable';
   ...
   */
  export function addImplementation (ctor) {
   ...
   */
  export function isImplementedBy(object) {
    if (!object) {
      return false;
    }
    try {
