...
namespace goog.math{
  export class Rect implements goog.math.IRect{
    left: number;
    top: number;
    width: number;
    height: number;
...
namespace goog.math.Rect{
   ...
   *     size.
   */
  export function createFromPositionAndSize(position, size) {
   ...
   *     and size.
   */
  export function createFromBox(box) {
   ...
   *     null.
   */
  export function boundingRect(a, b) {
    if (!a || !b) {
      return null;
    }
