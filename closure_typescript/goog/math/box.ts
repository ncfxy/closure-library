...
namespace goog.math{
  ...
  export class Box{
     ...
     *     inside the box.
     */
    public expandToIncludeCoordinate(coord) {
...
namespace goog.math.Box{
   ...
   */
  export function boundingBox (var_args) {
   ...
   */
  export function relativePositionX(box, coord) {
    if (coord.x < box.left) {
   ...
   *     side of {@code box}, or zero if {@code coord} is inside {@code box}.
   */
  export function relativePositionY(box, coord) {
    if (coord.y < box.top) {
   ...
   *     {@code box}.
   */
  export function distance(box, coord) {
   ...
   * @return {boolean} Whether the boxes intersect.
   */
  export function intersectsWithPadding(a, b, padding) {
    return (
