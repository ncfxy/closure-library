...
(function (goog) {
    ...
    (function (math) {
        var AffineTransform = /** @class */ (function () {
             ...
             * @final
             */
            function AffineTransform(opt_m00, opt_m10, opt_m01, opt_m11, opt_m02, opt_m12) {
        ...
        math.AffineTransform = AffineTransform;
...
(function (goog) {
    ...
    (function (math) {
        ...
        (function (AffineTransform) {
             ...
             *     transformation.
             */
            function getScaleInstance(sx, sy) {
                return new goog.math.AffineTransform().setToScale(sx, sy);
            }
            AffineTransform.getScaleInstance = getScaleInstance;
            ;
            /**
             ...
             */
            function getTranslateInstance(dx, dy) {
                return new goog.math.AffineTransform().setToTranslation(dx, dy);
            }
            AffineTransform.getTranslateInstance = getTranslateInstance;
            ;
            /**
             ...
             *     transformation.
             */
            function getShearInstance(shx, shy) {
                return new goog.math.AffineTransform().setToShear(shx, shy);
            }
            AffineTransform.getShearInstance = getShearInstance;
            ;
            /**
             ...
             *     transformation.
             */
            function getRotateInstance(theta, x, y) {
                return new goog.math.AffineTransform().setToRotation(theta, x, y);
            }
            AffineTransform.getRotateInstance = getRotateInstance;
            ;
        })(AffineTransform = math.AffineTransform || (math.AffineTransform = {}));
    })(math = goog.math || (goog.math = {}));
})(goog || (goog = {}));
