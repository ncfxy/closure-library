    ...
    (function (fs_1) {
        ...
        function get_(type, size) {
            ...
            if (!goog.isFunction(requestFileSystem)) {
                return goog.async.Deferred.fail(new fs_1.Error('File API unsupported'));
            }
            var d = new goog.async.Deferred();
            requestFileSystem(type, size, function (fs) { d.callback(new goog.fs.FileSystemImpl(fs)); }, function (err) {
         ...
         */
        var FileSystemType_;
        (function (FileSystemType_) {
            /**
             * A temporary filesystem may be deleted by the user agent at its discretion.
             */
            FileSystemType_[FileSystemType_["TEMPORARY"] = 0] = "TEMPORARY";
            /**
             * A persistent filesystem will never be deleted without the user's or
             * application's authorization.
             */
            FileSystemType_[FileSystemType_["PERSISTENT"] = 1] = "PERSISTENT";
        })(FileSystemType_ = fs_1.FileSystemType_ || (fs_1.FileSystemType_ = {}));
        ;
        /**
         ...
         *     error occurs, the errback is called with a {@link goog.fs.Error}.
         */
        function getPersistent(size) {
            return goog.fs.get_(goog.fs.FileSystemType_.PERSISTENT, size);
        }
        fs_1.getPersistent = getPersistent;
        ;
        /**
        ...
        fs_1.createObjectUrl = createObjectUrl;
        ;
        /**
        ...
        fs_1.revokeObjectUrl = revokeObjectUrl;
        ;
        /**
        ...
        fs_1.browserSupportsObjectUrls = browserSupportsObjectUrls;
        ;
        /**
        ...
        function getBlobWithProperties(parts, opt_type, opt_endings) {
            ...
            if (goog.isDef(BlobBuilder)) {
                ...
                throw new fs_1.Error('This browser doesn\'t seem to support creating Blobs');
            }
        }
        fs_1.getBlobWithProperties = getBlobWithProperties;
        ;
        /**
         ...
         */
        function blobToString(blob, opt_encoding) {
            return goog.fs.FileReader.readAsText(blob, opt_encoding);
        }
        fs_1.blobToString = blobToString;
        ;
        /**
         ...
         */
        function sliceBlob(blob, start, opt_end) {
