/// <reference path="../async/freelist.ts" />
...
(function (goog) {
    ...
    var Promise = /** @class */ (function () {
         ...
         * @final
         */
        function Promise(resolver, opt_context) {
            /**
         ...
         * @override
         */
        Promise.prototype.then = function (opt_onFulfilled, opt_onRejected, opt_context) {
         ...
         * @template THIS
         */
        Promise.prototype.thenVoid = function (opt_onFulfilled, opt_onRejected, opt_context) {
            if (opt_onFulfilled != null) {
                goog.asserts.assertFunction(opt_onFulfilled, 'opt_onFulfilled should be a function.');
            }
            if (opt_onRejected != null) {
         ...
         * @private
         */
        Promise.prototype.addChildPromise_ = function (onFulfilled, onRejected, opt_context) {
         ...
         * @private
         */
        Promise.prototype.executeCallback_ = function (callbackEntry, state, result) {
...
(function (goog) {
    ...
    (function (Promise) {
        ...
        Promise.UNHANDLED_REJECTION_DELAY = 0;
        /**
        ...
        (function (State_) {
            ...
            State_[State_["PENDING"] = 0] = "PENDING";
            /** The Promise is blocked waiting for the result of another Thenable. */
            State_[State_["BLOCKED"] = 1] = "BLOCKED";
            /** The Promise has been resolved with a fulfillment value. */
            State_[State_["FULFILLED"] = 2] = "FULFILLED";
            /** The Promise has been resolved with a rejection reason. */
            State_[State_["REJECTED"] = 3] = "REJECTED";
        })(State_ = Promise.State_ || (Promise.State_ = {}));
        ;
        var CallbackEntry_ = /** @class */ (function () {
            /**
           ...
           */
            ...
            return CallbackEntry_;
        }());
        Promise.CallbackEntry_ = CallbackEntry_;
        Promise.DEFAULT_MAX_UNUSED = 100;
        /** @const @private {goog.async.FreeList<!goog.Promise.CallbackEntry_>} */
        Promise.freelist_ = new goog.async.FreeList(function () { return new goog.Promise.CallbackEntry_(); }, function (item) { item.reset(); }, goog.Promise.DEFAULT_MAX_UNUSED);
        /**
         ...
         * @private
         */
        function getCallbackEntry_(onFulfilled, onRejected, context) {
        ...
        Promise.getCallbackEntry_ = getCallbackEntry_;
        ;
        /**
         * @param {!goog.Promise.CallbackEntry_} entry
         * @private
         */
        function returnEntry_(entry) {
            goog.Promise.freelist_.put(entry);
        }
        Promise.returnEntry_ = returnEntry_;
        ;
         ...
         * @private
         */
        function resolveThen_(value, onFulfilled, onRejected) {
            var isThenable = goog.Promise.maybeThen_(value, onFulfilled, onRejected, null);
            if (!isThenable) {
                goog.async.run(goog.partial(onFulfilled, value));
            }
        }
        Promise.resolveThen_ = resolveThen_;
        ;
        /**
        ...
        function allSettled(promises) {
            return new goog.Promise(function (resolve, reject) {
                ...
                for (var i = 0, promise; i < promises.length; i++) {
                    promise = promises[i];
                    goog.Promise.resolveThen_(promise, goog.partial(onSettled, i, true /* fulfilled */), goog.partial(onSettled, i, false /* fulfilled */));
                }
            });
        }
        ...
        Promise.firstFulfilled = firstFulfilled;
        ;
        /**
        ...
        Promise.withResolver = withResolver;
        ;
        /**
         ...
         * @private
         */
        function maybeThen_(value, onFulfilled, onRejected, context) {
         ...
         * @private
         */
        function tryThen_(thenable, then, onFulfilled, onRejected, context) {
            var called = false;
         ...
         * @private
         */
        function invokeCallback_(callbackEntry, state, result) {
        ...
        Promise.invokeCallback_ = invokeCallback_;
        ;
        /**
         ...
         * @private
         */
        function addUnhandledRejection_(promise, reason) {
            if (goog.Promise.UNHANDLED_REJECTION_DELAY > 0) {
        ...
        Promise.addUnhandledRejection_ = addUnhandledRejection_;
        ;
        /**
         ...
         * @private
         */
        Promise.handleRejection_ = goog.async.throwException;
        /**
         ...
         */
        function setUnhandledRejectionHandler(handler) {
            goog.Promise.handleRejection_ = handler;
        }
        Promise.setUnhandledRejectionHandler = setUnhandledRejectionHandler;
        ;
    })(Promise = goog.Promise || (goog.Promise = {}));
})(goog || (goog = {}));
/**
    ...
    (function (Promise) {
        var CancellationError = /** @class */ (function (_super) {
            ...
            function CancellationError(opt_message) {
                var _this = _super.call(this, opt_message) || this;
                _this.name = 'cancel';
                return _this;
        ...
        var Resolver_ = /** @class */ (function () {
             ...
             * @template TYPE
             */
            function Resolver_(promise, resolve, reject) {
                /** @const */
