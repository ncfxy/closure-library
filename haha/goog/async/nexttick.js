...
(function (goog) {
    ...
    (function (async) {
        ...
        async.throwException = throwException;
        /**
...
(function (goog) {
    ...
    (function (async) {
        ...
        (function (nextTick) {
            ...
            nextTick.useSetImmediate_ = useSetImmediate_;
            ;
            /**
             ...
             * @private
             */
            function getSetImmediateEmulator_() {
            ...
            nextTick.getSetImmediateEmulator_ = getSetImmediateEmulator_;
            ;
            /**
        ...
        })(nextTick = async.nextTick || (async.nextTick = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
