...
(function (goog) {
    ...
    (function (async) {
        ...
        (function (run) {
            ...
            run.initializeRunner_ = initializeRunner_;
            ;
            /**
             ...
             */
            function forceNextTick(opt_realSetTimeout) {
                goog.async.run.schedule_ = function () {
                    goog.async.nextTick(goog.async.run.processWorkQueue);
            ...
            run.forceNextTick = forceNextTick;
            ;
            /** @private {boolean} */
            run.workQueueScheduled_ = false;
            /** @private {!goog.async.WorkQueue} */
            run.workQueue_ = new goog.async.WorkQueue();
            // if (goog.DEBUG) {
            /**
            ...
            run.processWorkQueue = processWorkQueue;
            ;
        })(run = async.run || (async.run = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
