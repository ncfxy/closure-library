    ...
    (function (html) {
        ...
        (function (utils) {
            ...
            function stripHtmlTags(value) {
                ...
                return goog.string.unescapeEntities(goog.string.trim(value
                    .replace(goog.html.utils.HTML_TAG_REGEX_, function (fullMatch, tagName) {
             ...
             * @private @const
             */
            utils.INLINE_HTML_TAG_REGEX_ = /^(?:abbr|acronym|address|b|em|i|small|strong|su[bp]|u)$/i;
            /**
             ...
             * @private @const
             */
            utils.HTML_TAG_REGEX_ = /<[!\/]?([a-z0-9]+)([\/ ][^>]*)?>/gi;
        })(utils = html.utils || (html.utils = {}));
