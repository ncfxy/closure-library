    ...
    (function (async) {
        ...
        var Deferred = /** @class */ (function () {
            /**
              ...
              * @constructor
              */
            function Deferred(opt_onCancelFunction, opt_defaultScope) {
                /**
                ...
                if (goog.async.Deferred.LONG_STACK_TRACES) {
                    ...
                    if (goog.global.Error.captureStackTrace) {
                        var target = { stack: '' };
                        goog.global.Error.captureStackTrace(target, goog.async.Deferred);
             ...
             * @override
             */
            Deferred.prototype.then = function (opt_onFulfilled, opt_onRejected, opt_context) {
                var resolve, reject;
...
(function (goog) {
    ...
    (function (async) {
        var Deferred;
        (function (Deferred) {
            Deferred.STRICT_ERRORS = false;
            Deferred.LONG_STACK_TRACES = false;
        })(Deferred = async.Deferred || (async.Deferred = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
/**
...
(function (goog) {
    ...
    (function (async) {
        ...
        (function (Deferred) {
            ...
            Deferred.fromPromise = fromPromise;
            ;
            /**
             ...
             * @template T
             */
            function when(value, callback, opt_scope) {
...
(function (goog) {
    ...
    (function (async) {
        var Deferred;
        (function (Deferred) {
            var AlreadyCalledError = /** @class */ (function (_super) {
                 ...
                 */
                function AlreadyCalledError(deferred) {
                    var _this = _super.call(this) || this;
                    /** @override */
                    _this.message = 'Deferred has already fired';
                    /** @override */
                    _this.name = 'AlreadyCalledError';
                    goog.debug.Error.call(_this);
                    /**
            ...
            Deferred.AlreadyCalledError = AlreadyCalledError;
        })(Deferred = async.Deferred || (async.Deferred = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
(function (goog) {
    ...
    (function (async) {
        ...
        (function (Deferred) {
            var CanceledError = /** @class */ (function (_super) {
                 ...
                 * @extends {goog.debug.Error}
                 */
                function CanceledError(deferred) {
                    var _this = _super.call(this) || this;
                    /** @override */
                    _this.message = 'Deferred was canceled';
                    /** @override */
            ...
            Deferred.CanceledError = CanceledError;
        })(Deferred = async.Deferred || (async.Deferred = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
(function (goog) {
    ...
    (function (async) {
        ...
        (function (Deferred) {
            var Error_ = /** @class */ (function () {
                 ...
                 * deferred errors.
                 */
                Error_.prototype.throwError = function () {
                 ...
                 */
                Error_.prototype.resetTimer = function () {
                    goog.global.clearTimeout(this.id_);
                };
                ;
                return Error_;
            }());
            Deferred.Error_ = Error_;
        })(Deferred = async.Deferred || (async.Deferred = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
(function (goog) {
    ...
    (function (async) {
        ...
        (function (Deferred) {
             ...
             * @private
             */
            function scheduleError_(error) {
                var deferredError = new goog.async.Deferred.Error_(error);
                goog.async.Deferred.errorMap_[deferredError.id_] = deferredError;
                return deferredError.id_;
            }
            Deferred.scheduleError_ = scheduleError_;
            ;
            /**
            ...
            Deferred.unscheduleError_ = unscheduleError_;
            ;
            /**
            ...
            Deferred.assertNoErrors = assertNoErrors;
            ;
        })(Deferred = async.Deferred || (async.Deferred = {}));
    })(async = goog.async || (goog.async = {}));
})(goog || (goog = {}));
